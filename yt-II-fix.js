...
function onYouTubeIframeAPIReady(){
	...
	t.setAttribute("id","youtube-icon"),t.style.cssText="cursor:pointer;cursor:hand",e.appendChild(t);var a=document.createElement("div");
	a.setAttribute("id","youtube-player"),e.appendChild(a);
	var o=function(e){
		var a=e?"S4qbDDC.png":"S4qbDDC.png";t.setAttribute("src","https://i.imgur.com/"+a)};
	e.onclick=function(){
					      ...
					      events:{
						      onReady:function(e){
							      r.setPlaybackQuality("small"),
								      o(
									      r.getPlayerState()!==YT.PlayerState.CUED)},
